...
var _user$project$Types$Post = F2(
	function (a, b) {
		return {title: a, content: b};
	});
var _user$project$Types$Pang = {ctor: 'Pang'};
var _user$project$Types$UpdateTitle = function (a) {
	return {ctor: 'UpdateTitle', _0: a};
};

var _user$project$Service$apply = F2(
	function (func, value) {
		return A3(
...
var _user$project$Service$queryResult = function (decoder) {
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					['data']),
				decoder),
				_elm_lang$core$Json_Decode$fail('expecting data')
			]));
};
var _user$project$Service$query = F3(
	function (url, query, decoder) {
		return A2(
			_evancz$elm_http$Http$get,
			_user$project$Service$queryResult(decoder),
			A2(
...
var _user$project$Service$url = 'http://localhost:4000/graphql';

var _user$project$State$update = F2(
	function (action, model) {
		var _p0 = action;
		if (_p0.ctor === 'UpdateTitle') {
			return model;
		} else {
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					posts: A2(
						...
						function (p) {
							return !_elm_lang$core$Native_Utils.eq(p.title, 'hej');
						},
						model.posts)
				});
		}
	});
var _user$project$State$nejPost = {title: 'NEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEJ', content: 'SLUTA FIS!!!!!!'};
var _user$project$State$newPost = {title: 'hej', content: 'Simple card. I am good at containing small bits of information.\n      I am convenient because I require little markup to use effectively.'};
var _user$project$State$model = {
	posts: _elm_lang$core$Native_List.fromArray(
		[_user$project$State$newPost, _user$project$State$newPost, _user$project$State$nejPost])
};

var _user$project$View$post = function (post) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_elm_lang$html$Html_Attributes$attribute, 'class', 'col l6 offset-l3 card')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A2(_elm_lang$html$Html_Attributes$attribute, 'class', 'card-content')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										A2(_elm_lang$html$Html_Attributes$attribute, 'class', 'card-title')
									]),
								_elm_lang$core$Native_List.fromArray(
									[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A2(_elm_lang$html$Html_Attributes$attribute, 'class', 'card-action')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
...
var _user$project$View$view = function (model) {
	var posts = A2(_elm_lang$core$List$map, _user$project$View$post, model.posts);
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											A2(_elm_lang$html$Html_Attributes$attribute, 'class', 'right hide-on-med-and-down')
										]),
									_elm_lang$core$Native_List.fromArray(
										[
											A2(
											...
											_elm_lang$core$Native_List.fromArray(
												[
													...
													_elm_lang$core$Native_List.fromArray(
														[
															A2(_elm_lang$html$Html_Attributes$attribute, 'href', 'sass.html')
														]),
													_elm_lang$core$Native_List.fromArray(
														[
															_elm_lang$html$Html$text('Sass')
														]))
												])),
											A2(
											_elm_lang$html$Html$li,
											...
											_elm_lang$core$Native_List.fromArray(
												[
													...
													_elm_lang$core$Native_List.fromArray(
														[
															A2(_elm_lang$html$Html_Attributes$attribute, 'href', 'badges.html')
														]),
													_elm_lang$core$Native_List.fromArray(
														[
															_elm_lang$html$Html$text('Components')
														]))
												])),
											A2(
											_elm_lang$html$Html$li,
											...
											_elm_lang$core$Native_List.fromArray(
												[
													...
													_elm_lang$core$Native_List.fromArray(
														[
															A2(_elm_lang$html$Html_Attributes$attribute, 'href', 'collapsible.html')
														]),
													_elm_lang$core$Native_List.fromArray(
														[
															_elm_lang$html$Html$text('Javascript')
														]))
												])),
											A2(
											_elm_lang$html$Html$li,
											...
											_elm_lang$core$Native_List.fromArray(
												[
													...
													_elm_lang$core$Native_List.fromArray(
														[
															A2(_elm_lang$html$Html_Attributes$attribute, 'href', 'mobile.html')
														]),
													_elm_lang$core$Native_List.fromArray(
														[
															_elm_lang$html$Html$text('Mobile')
														]))
												]))
										])),
									A2(
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												A2(_elm_lang$html$Html_Attributes$attribute, 'class', 'btn red'),
												_elm_lang$html$Html_Events$onClick(_user$project$Types$Pang)
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text('radera'),
												A2(
												_elm_lang$html$Html$i,
												_elm_lang$core$Native_List.fromArray(
													[
														A2(_elm_lang$html$Html_Attributes$attribute, 'class', 'large material-icons')
													]),
												_elm_lang$core$Native_List.fromArray(
													[
...
var _user$project$Main$main = {
	main: _elm_lang$html$Html_App$beginnerProgram(
		{model: _user$project$State$model, view: _user$project$View$view, update: _user$project$State$update})
};
